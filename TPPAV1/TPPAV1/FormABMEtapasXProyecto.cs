...
namespace TPPAV1
{
    public partial class FormABMEtapasXProyecto : Form
    {
        public FormABMEtapasXProyecto()
        {
            InitializeComponent();
            CargarGrilla();
        ...
        private void CargarGrilla()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT cod_proyecto, id_etapa, fecha_inicio, fecha_fin FROM [BD3K3G02_2022].[dbo].[ETAPASxPROYECTO] ORDER BY cod_proyecto ASC";
