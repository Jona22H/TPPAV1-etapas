...
namespace TPPAV1
{
    public partial class formABMEtapa : Form
    {
        public formABMEtapa()
        {
            ...
            FormABMEtapasXProyecto ventana = new FormABMEtapasXProyecto();
            ventana.Show();
            this.Hide();
        }
        ...
        private void CargarGrilla()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT id_etapa, descripcion FROM [BD3K3G02_2022].[dbo].[ETAPAS] ORDER BY id_etapa ASC";
